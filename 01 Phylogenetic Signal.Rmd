...
model_GP_phyloonly<-MCMCglmm(cbind((Successes),(Failures))~1,random=~Species,family="multinomial2",ginverse=list(Species=Ainv),prior = prior_to_beat2, data=seedDat_spp,nitt=3000000,burnin=100000,thin=500)       
