...
model_GP_phyloonly_gauss<-MCMCglmm(GP~1,random=~Species,family="gaussian",ginverse=list(Species=Ainv),prior = prior_stronger, data=seedDat_spp,nitt=3000000,burnin=100000,thin=500)       
