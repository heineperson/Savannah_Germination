...
## Specifiying scenarios for diagnositic testing
...
The statistic calculated here is the K statistic (https://cran.r-project.org/web/packages/picante/vignettes/picante-intro.pdf)
