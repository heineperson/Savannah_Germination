...
# Ana's seed database
seedDat <- fread("Savanna seed database.csv")
...
# Old Phylogeny (from Ana)

Missing a species (Kielmeyera_coriacea)

```{r old phylogeny}
tree <- "((((((((((((((((((((((((((((((((((Tabebuia_ochraceae)tabebuia)bignoniaceae))))))))))lamiales,(((((((((((((((Solanum_lycocarpum)solanum)solaneae)))))))solanoideae))))solanaceae))solanales),(((((((((Palicourea_rigida)palicourea))))))rubioideae)rubiaceae)gentianales))lamiids,(((((((((Eremanthus_glomerultatus)eremanthus)asteraceae)))))asterales))campanulids),((((((((Styraxferrugineous)styrax)styracaceae))))))ericales)ericales_to_asterales)asterids,((((((((((((((Guapira_graciliflora,Guapira_noxia)guapira)nyctaginaceae))))))))))))caryophyllales))),((((((((((Ouratea_floribunda,Ouratea_hexasperma)ouratea)ochnaceae,(((Maprounea_brasiliensis)maprounea)euphorbiaceae),((((Erythroxylum_suberosum)erythroxylum)erythroxylaceae)))malpighiales,(((((Rourea_induta)rourea)connaraceae)))oxalidales))celastrales_to_malpighiales,(((((((((((((((((((Machaerium_acutifolium)machaerium))dalbergia_group))dalbergieae)),(((Acosmium_dasycarpum)acosmium)ormosieae)genistoids)))))papilionoideae,((((((((((((((((((Calliandra_dysantha)calliandra)inga_alliance))ingeae)))))))))mimosoids)),(((Chamaecrista_orbiculata)chamaecrista)cassiinae))))))))fabaceae))fabales,((((((((Brosimum_gaudichaudii)brosimum)moraceae)))))rosales))))fabids,((((((((((((((((((((((Campomanesia_pubescens)campomanesia))))pimentagroup))))))myrteae)myrteaestem))))myrtaceae),(((Miconia_ferruginata)miconia)melastomataceae))))myrtales),((((((((((Eriotheca_pubescens)eriotheca)malvaceae)))malvales)malvales_to_brassicales)huerteales_to_brassicales))))malvids))rosids)))core_eudicots)trochodendrales_to_asterales)sabiales_to_asterales)eudicots)ceratophyllales_and_eudicots)poales_to_asterales)magnoliales_to_asterales)austrobaileyales_to_asterales)nymphaeales_to_asterales)angiosperms)seedplants)euphyllophyte[NOTE: 1 taxa not matched: callophyllaceae/kielmeyera/Kielmeyera_coriacea, ];"
...
# # Read in the megaphylogeny
 ...
 nodes <- as.data.table(read_delim("nodes.csv", "\t", escape_double = FALSE,  trim_ws = TRUE))
...
prior<-list(G=list(G1=list(V=1,nu=.5)),R=list(V=1,nu=0.1))
...
model_T50_spp<-MCMCglmm(log(T50_mean)~1,random=~Species,
                    family="gaussian",ginverse=list(Species=Ainv),prior=prior,
                    data=seedDat_spp,nitt=3000000,burnin=100000,thin=50)
