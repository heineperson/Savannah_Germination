...
# DM + MC + SM + Dorm
model_T50_4a <- MCMCglmm(log(T50)~DM + MC + log(SM)+Dormancy2Cat ,random=~Species,family="gaussian",ginverse=list(Species=Ainv),prior=prior,data=seedDat,nitt=300000,burnin=10000,thin=50)
# DM + MC + SM + VegType
model_T50_4b <- MCMCglmm(log(T50)~DM + MC + log(SM)+VegType ,random=~Species,family="gaussian",ginverse=list(Species=Ainv),prior=prior,data=seedDat,nitt=300000,burnin=10000,thin=50)
# MC + SM + VegType + Dorm
model_T50_4c <- MCMCglmm(log(T50)~ MC + log(SM)+Dormancy2Cat+ VegType ,random=~Species,family="gaussian",ginverse=list(Species=Ainv),prior=prior,data=seedDat,nitt=300000,burnin=10000,thin=50)
# SM + VegType + Dorm + DM  ## BEST MODEL ##
model_T50_4d <- MCMCglmm(log(T50)~log(SM)+VegType+Dormancy2Cat+DM ,random=~Species,family="gaussian",ginverse=list(Species=Ainv),prior=prior,data=seedDat,nitt=300000,burnin=10000,thin=50)

## 3 Variables (4 chose 3 = 4)
# SM + VegType + Dorm
model_T50_3a <- MCMCglmm(log(T50)~log(SM)+VegType+Dormancy2Cat ,random=~Species,family="gaussian",ginverse=list(Species=Ainv),prior=prior,data=seedDat,nitt=300000,burnin=10000,thin=50)
# SM + VegType + DM
model_T50_3b <- MCMCglmm(log(T50)~log(SM)+VegType+DM ,random=~Species,family="gaussian",ginverse=list(Species=Ainv),prior=prior,data=seedDat,nitt=300000,burnin=10000,thin=50)
# VegType + DM + Dorm
model_T50_3c <- MCMCglmm(log(T50)~VegType+DM+Dormancy2Cat ,random=~Species,family="gaussian",ginverse=list(Species=Ainv),prior=prior,data=seedDat,nitt=300000,burnin=10000,thin=50)
# DM + Dorm + SM  ## BEST MODEL ##
model_T50_3d <- MCMCglmm(log(T50)~DM+Dormancy2Cat+log(SM) ,random=~Species,family="gaussian",ginverse=list(Species=Ainv),prior=prior,data=seedDat,nitt=300000,burnin=10000,thin=50)
...
# SM + DORM ## BEST MODEL##
model_T50_2c <- MCMCglmm(log(T50)~log(SM)+Dormancy2Cat ,random=~Species,family="gaussian",ginverse=list(Species=Ainv),prior=prior,data=seedDat,nitt=3000000,burnin=100000,thin=500)
