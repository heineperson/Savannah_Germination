...
## 5 variables
# SM + VegType + Dorm + DM + LS ## BEST MODEL##
model_GP_5_glmer <- glmer(cbind(Successes,Failures)~log(SM)+VegType+Dormancy2Cat+DM+LifeSpan +(1|Species),family="binomial",data=seedDat)   
summary(model_GP_5_glmer)
